	...
	<div class="widget">
		...
		<div class="table">
			<table>
				...
				<tfoot>
					{{Form::open(array('route' => array('admin.fields.update', $editField->id), 'method' => 'PUT'))}}
						<tr>
							<td colspan="1" style="padding: 0px 7px;">
								<input type="text" dir="rtl" name="updateField" id="form_field" class="validate_text" placeholder="اضافه کردن" value="{{$editField->title}}" />
							</td>
							<td>
								<input type="submit" name="submit" value="ذخیره" class="buttonH bLightBlue" style="float: none;" />
								{{link_to_route('admin.fields.index','انصراف',null, array('class' => 'button'))}}
							</td>
						</tr>
					{{Form::close()}}
				</tfoot>
